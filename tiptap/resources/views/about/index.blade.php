...
<section class="section-bg" ;>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 ms-auto" style="justify-content: end">
                <img src="{{ url('img/vision.svg') }}" style="width:250px; height:auto" />
            </div>
        </div>
    </div>
</section>
...
<section class="section-bg" style="background-color:#fbe192" ;>
    <div class="container">
        <div class="row" style="justify-content: end">
            <div class="col">
                <img class="img-flex" src="{{ url('img/mission.svg') }}" style="width:250px; height:auto" />
            </div>
            <div class="col-md-4" style="justify-content: end">
                <h2 class="" style="text-align:right"><strong>Mission</strong></h2>
                <br>
                <p style="text-align:right;">We provide exceptional customer service, great prices, security, and convenience. We have the perfect storage unit available for you. Start storing with us today!
                </p>
            </div>
        </div>
    </div>
...
<section class="book-section">
    <div class="container">
        ...
        <div class="row text-center" , style="justify-content: center">
            <div class="col-md-4">
                <img src="{{ url('img/leona.jpg') }}" style="border-radius:70%; width:180px; height:auto;" />
                <h4 class="my-3">Leona Rose</h4>
                <p class="text-muted">1972034</p>
            </div>
            <div class="col-md-4">
                <img src="{{ url('img/exel.jpg') }}" style="width:180px; border-radius:70%; height:180px;" />
