...
<header class="masthead">
     <div class="container">
         ...
         <button class="btn btn-primary btn-xl text-uppercase"><a href="{{route('storage')}}" style="color:white; padding:0;">Book Now</a></button>
     </div>
 </header>
 <!-- ========= End Header ========= -->
 ...
 <section class="book-section" id="services">
     <div class="container">
         ...
         <button class="btn btn-primary btn-xl text-uppercase btn-book"><a style="color:white;" href="{{ route('storage')}}"> Book Now </a></button>
     </div>
 </section>
